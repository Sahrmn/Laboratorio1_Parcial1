...
int main()
{
    ...
    cargaUsuarioProductos(producto,user);
    ...
    while(seguir=='s')
    {
        ...
        switch(opcion)
        {
            case 1: //Alta de usuario
                ...
                printf("***********************\n\n");
                comprobacion = altaUsuario(user, US);
                if(comprobacion == -1)
                {
            ...
            case 2: //Modificar usuario
                ...
                printf("******************************\n\n");
                comprobacion = modificarUsuario(user, US);
                if(comprobacion == -1)
                {
            ...
            case 3: //Baja del usuario
                ...
                printf("***********************\n\n");
                comprobacion = bajaUsuario(user,producto,US,PR);
                if(comprobacion == -1)
                {
            ...
            case 4: //Publicar producto
                ...
                printf("*******************************\n\n");
                comprobacion = publicarProducto(user,producto,US,PR);
                if(comprobacion == -1)
                {
            ...
            case 5: //Modificar publicacion
                ...
                printf("***********************************\n\n");
                comprobacion = modificarPublicacion(user,producto,US,PR);
                if(comprobacion == -1)
                {
            ...
            case 6: //Cancelacion de publicaciones de usuario
                ...
                printf("**********************************\n\n");
                comprobacion = cancelarPublicacion(user,producto,US,PR);
                if(comprobacion == -1)
                {
            ...
            case 7: //Comprar producto
                ...
                printf("**************************\n\n");
                comprobacion = compraProducto(producto,user,PR,US);
                if(comprobacion == -1)
                {
            ...
            case 9: //Listar publicaciones
                ...
                printf("**************************\n\n");
                mostrarProductos(producto,user,PR,US);
                printf("\n");
                break;
